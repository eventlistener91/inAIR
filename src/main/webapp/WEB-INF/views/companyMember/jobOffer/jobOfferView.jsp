		            	...
		            	<div class="divStyle marginTop">
		            		...
		            		<div style="clear:both;">
			            		<c:forEach items="${jobOfferFileList}" var="jobOfferFileInfo">
			            			<input type="button" class="btn" value="${jobOfferFileInfo.jo_file_name}" onclick="javascript:location.href='${comMemJobOfferURL}/jobOfferFileDownload.do?jo_file_savename=${jobOfferFileInfo.jo_file_savename}&jo_file_name=${jobOfferFileInfo.jo_file_name}'" >
			            		</c:forEach>
		            		</div>
		            	</div>
	            	</c:if>
