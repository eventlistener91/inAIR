...
// 								corpCode = cropCodeValue;
	...
	$('#searchSubmit').click(function() {
		...
		var corp_lowPro = $('#proNumInput').val();
...
function AIIMTHome(){
	if(${empty LOGIN_INDVDLMEMINFO}){
		...
		location.href='${pageContext.request.contextPath}/AIIMT/AIIMTHome.do';
	}
}
...
function characterHome(){
	if(${empty LOGIN_INDVDLMEMINFO}){
		...
		location.href='/character/characterHome.do';
	}
} 
								...
								<div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
									<div class="block-18 text-center">
										<div class="text d-flex">
											...
											<div class="desc text-left">
												<strong class="number" data-number="${jobOfferCount}0"></strong><span>구인글 등록수</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
									<div class="block-18 text-center">
										<div class="text d-flex">
											...
											<div class="desc text-left">
												<strong class="number" data-number="${indvdlMemCount}0"></strong><span>구직자 등록수</span>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row no-gutters">
							<div class="col-md-2" onclick="javascript:location.href='/companySearch/companySearchHome.do'">
								<div class="top-category text-center no-border-left">
									...
									<p>
										<span>news of employment</span>
									</p>
								</div>
							</div>
							<div class="col-md-2" onclick="AIIMTHome();">
							...
							<div class="col-md-2" onclick="characterHome();">
								<div class="top-category text-center">
									<h3>
										<p>인성역량검사</p>
									</h3>
									...
									<p>
										<span>personality capacity</span>
									</p>
								</div>
							</div>
							<div class="col-md-2" onclick="resumeHome();">
								<div class="top-category text-center">
									<h3>
										<p>이력서관리</p>
									</h3>
							...
							<div class="col-md-2" onclick="myPageHome();">
								<div class="top-category text-center">
									<h3>
										<p>개인정보관리</p>
									</h3>
