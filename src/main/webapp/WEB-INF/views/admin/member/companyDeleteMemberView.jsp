...
<script type="text/javascript">
	$(function(){
		$('#comMemListBTN').click(function(){
			location.href="${adminMemberManagementURL}/companyDeleteMemberList.do";
		});
	});
</script>
</head>
		        ...
		        <div class="widget-box" style="height:100%;">
		          ...
		          <div class="widget-content nopadding" style="height:94%;">
		            <form action="#" method="get" class="form-horizontal" style="height:99%;">
		              ...
		              <div class="control-group" style="height:8%; padding-left:10%;">
		              ...
		              <div class="control-group" style="height:8%; padding-left:10%;">
		                ...
		                <div class="controls">
		                  <span class="help-block" style="margin-top:5px;">${companyMemInfo.com_secsn}</span>
		                </div>
		              </div>
